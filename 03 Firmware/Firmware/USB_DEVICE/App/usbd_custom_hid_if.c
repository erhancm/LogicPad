...
static int8_t CUSTOM_HID_OutEvent_FS(uint8_t event_idx, uint8_t state)
{
  ...
  if (hhid != NULL) {
    hid_vendor_on_out(hhid->Report_buf, USBD_CUSTOMHID_OUTREPORT_BUF_SIZE);
  }
  return (USBD_OK);
  /* USER CODE END 6 */
}
