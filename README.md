<p align="center">
  <img src=".github/assets/logo.png" alt="LogicPad" width="96" height="96">
</p>
...
<table>
  <tr>
    <td colspan="2" align="center">
      <img src=".github/assets/app-keys.png" alt="LogicPad configurator — Keys tab with 3×3 grid, macro steps, and typed text" width="100%">
      <br><sub><b>Keys</b> — macros, chords, typed text, and drag-and-drop PC program launch</sub>
    </td>
  </tr>
  <tr>
    <td width="50%" align="center">
      <img src=".github/assets/app-profiles.png" alt="LogicPad configurator — Profiles tab with lighting modes and per-key colours" width="100%">
      <br><sub><b>Profiles</b> — wave, ripple, breathe &amp; rain lighting · per-key colours · OLED settings</sub>
    </td>
    <td width="50%" align="center">
      <img src=".github/assets/app-auto-switch.png" alt="LogicPad configurator — Auto-switch node graph" width="100%">
...
<p align="center">
  <img src=".github/assets/hero.jpg" alt="LogicPad macro pad — OLED showing Media profile, per-key RGB backlight" width="720">
</p>
   ...
   <table>
     <tr>
       ...
       <td width="45%" align="center">
         <img src=".github/assets/keypad.png" alt="LogicPad keypad layout" width="100%">
       </td>
     </tr>
   </table>
...
| [`05 Hardware/`](05%20Hardware/) | 3D-printable enclosure — STEP files for the case and button caps. |
| [`.github/assets/`](.github/assets/) | Images used in this README. |
